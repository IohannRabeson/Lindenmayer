...
TEST(AbstractSyntaxTreeTest, CompareTree_01)
{
    ...
    rootLeft->addChild(std::make_unique<NumericNode>(nullptr, 1));
    rootLeft->addChild(std::make_unique<NumericNode>(nullptr, 2));

    std::unique_ptr<AbstractSyntaxTreeNode> rootRight = std::make_unique<AdditionNode>(nullptr);
    rootRight->addChild(std::make_unique<NumericNode>(nullptr, 1));
    rootRight->addChild(std::make_unique<NumericNode>(nullptr, 2));
...
TEST(AbstractSyntaxTreeTest, CompareTree_01b)
{
    ...
    std::unique_ptr<AbstractSyntaxTreeNode> rootRight = std::make_unique<AdditionNode>(nullptr);
    rootRight->addChild(std::make_unique<NumericNode>(nullptr, 1));
    rootRight->addChild(std::make_unique<NumericNode>(nullptr, 56789));
...
TEST(AbstractSyntaxTreeTest, CompareTree_02)
{
    ...
    leftLeftAdd->addChild(std::make_unique<NumericNode>(nullptr, 3));
    leftLeftAdd->addChild(std::make_unique<NumericNode>(nullptr, 4));

    std::unique_ptr<AbstractSyntaxTreeNode> rootRight = std::make_unique<AdditionNode>(nullptr);
    rootRight->addChild(std::make_unique<NumericNode>(nullptr, 1));
    auto* leftRightAdd = rootRight->addChild(std::make_unique<AdditionNode>(nullptr));
    leftRightAdd->addChild(std::make_unique<NumericNode>(nullptr, 3));
    leftRightAdd->addChild(std::make_unique<NumericNode>(nullptr, 4));
...
TEST(AbstractSyntaxTreeTest, CompareTree_02b)
{
    ...
    auto* leftRightAdd = rootRight->addChild(std::make_unique<AdditionNode>(nullptr));
    leftRightAdd->addChild(std::make_unique<NumericNode>(nullptr, 3));
    leftRightAdd->addChild(std::make_unique<NumericNode>(nullptr, 56789));
